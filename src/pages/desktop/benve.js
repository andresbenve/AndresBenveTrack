...
function Studio() {
  ...
  return (
    ...
    <div onClick={() => router.push(`${process.env.ACTUAL}/desktop/hlearning`)} className="fixed z-50 bottom-0 right-0 buttonPagar w-1/2 ">Siguiente proyecto →</div>
  ...
  <div className="flex justify-center bg-white benveHtmlDivDesktop">
    <iframe className="benveHtmlDesktop" src="https://benve.com.ar" lazyloading frameborder="0"></iframe>
  </div>
  </div>
  );
}
