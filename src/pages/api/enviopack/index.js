...
class EnvioPack {
  constructor(apiKey, secretKey, logger = console, _axios = axios) {
    ...
    this.cotizar = require("./cotizar")(
      this.client,
      this.apiKey,
      this.secretKey
    );
    this.sucursales = require("./sucursales")(
      this.client,
      this.apiKey,
      this.secretKey
    );
    this.localidades = require("./localidades")(
      this.client,
      this.apiKey,
      this.secretKey
    );
    this.pedidos = require("./pedidos")(
      this.client,
      this.apiKey,
      this.secretKey
    );
    this.envios = require("./envios")(this.client, this.apiKey, this.secretKey);
    this.correos = require("./correos")(
      this.client,
      this.apiKey,
      this.secretKey
    );
    this.provincias = require("./provincias")(
      this.client,
      this.apiKey,
      this.secretKey
    );
  ...
  wrapClient(axiosClient) {
    ...
    async function handleError(error, method, ...args) {
      if (
        ...
        self.logger.log(
          "Authentication error, we should regenerate the access_token"
        );
        const access_token = await auth.create(
          axiosClient,
          self.apiKey,
          self.secretKey
        );
...
module.exports = () =>
  new EnvioPack(
    "8954123a3b36c3fca47b0ebf07aaaab86a38fb65",
    "b04bff3645dec289a734425b95c9df287072e4c5"
  );
