...
function Studio() {
  ...
  return (
    ...
    <div onClick={() => router.push('https://andres-benve-track.vercel.app/mobile/hlearning')} className="fixed z-50 bottom-0 right-0 buttonPagar w-1/2 ">Siguiente proyecto →</div>
  ...
  <div className="flex justify-center bg-white benveHtmlDiv">
    <iframe className="benveHtml" src="https://benve.com.ar" lazyloading frameborder="0"></iframe>
  </div>
  </div>
  );
}
