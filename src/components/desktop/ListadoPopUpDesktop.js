...
function ListadoPopUp() {
  ...
  if (!isDressUp && !isMerchandising && !isBags && !isArt) {
    return (
      <div className="grid grid-cols-2 gap-2 flex flex-col flex-grow mt-20">
    ...
    return (
      <div className="grid grid-cols-2 gap-2 flex flex-col flex-grow mt-20">
        <div
          ...
          className="fixed relative top-12 left-0 h-6 w-6"
        >
          <ChevronLeftIcon />
        </div>
...
function ListadoPopUp() {
  ...
  if (!isCamisas && !isZapatos && !isSweater) {
    return (
      <div className="grid grid-cols-2 gap-2 flex flex-col flex-grow mt-20">
      <div className="fixed relative top-0 left-0">
      <ChevronLeftIcon>
      <div className="col-span-2 text-center m-4 font-bold">NEW IN</div>
        <div
